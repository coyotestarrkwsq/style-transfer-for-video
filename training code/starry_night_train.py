...
CONTENT_WEIGHT = 1 #1 #3 #5
STYLE_WEIGHT = 20 #20
TEMPORAL_WEIGHT = 10 #10
TV_WEIGHT = 1e-3 #30 #10
...
def optimize(save_path, content_targets, style_target, content_weight ,style_weight, temporal_weight,
    ...
    with tf.Graph().as_default(),  tf.Session() as sess:
        ...
        #saver.restore(sess, "/home/wangsq/CS4243/DAVIS_model/starry_night_model/model.ckpt")
...
style_target = home + "starry-night.jpg"
...
log_dir = home + "DAVIS_model/starry_night_model/"
save_path= home + 'DAVIS_model/starry_night_model/model.ckpt'
