...
def optimize(save_path, content_targets, style_target, content_weight ,style_weight, temporal_weight,
    ...
    with tf.Graph().as_default(),  tf.Session() as sess:
        ...
        #saver.restore(sess, "/home/wangsq/CS4243/DAVIS_model/la_muse_model/model.ckpt")
...
log_dir = home + "DAVIS_model/la_muse_model/"
save_path= home + 'DAVIS_model/la_muse_model/model.ckpt'
